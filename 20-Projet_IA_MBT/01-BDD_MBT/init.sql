...
-- Création du trigger pour vérifier la cohérence entre client_id et contact_id
...
-- Création d'une vue pour afficher les bons d'intervention avec les infos du contact
